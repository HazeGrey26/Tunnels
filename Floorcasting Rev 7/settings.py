...
hres = int(screenResX*render_scale)  # Horizontal resolution of the game render
halfvres = int(screenResY*render_scale/2)  # Half of the vertical resolution of the game render
